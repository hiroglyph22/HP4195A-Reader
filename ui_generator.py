...
class UIGenerator:
    ...
    def generate_power_control_section(self):
        self.start_power_label = QtWidgets.QLabel('Start Power (dBm):', self)
        self.start_power_label.resize(140, 30)
        self.start_power_label.move(1050, 935)
        self.start_power_input = QtWidgets.QLineEdit(self)
        self.start_power_input.setPlaceholderText("-20")
        self.start_power_input.move(1195, 935)
        self.start_power_input.resize(100, 30)

        self.stop_power_label = QtWidgets.QLabel('Stop Power (dBm):', self)
        self.stop_power_label.resize(140, 30)
        self.stop_power_label.move(1050, 970)
        self.stop_power_input = QtWidgets.QLineEdit(self)
        self.stop_power_input.setPlaceholderText("0")
        self.stop_power_input.move(1195, 970)
        self.stop_power_input.resize(100, 30)

        self.step_power_label = QtWidgets.QLabel('Step (dBm):', self)
        self.step_power_label.resize(140, 30)
        self.step_power_label.move(1050, 1005)
        self.step_power_input = QtWidgets.QLineEdit(self)
        self.step_power_input.setPlaceholderText("1")
        self.step_power_input.move(1195, 1005)
        self.step_power_input.resize(100, 30)
        
        self.power_sweep_button = QtWidgets.QPushButton('Start Power Sweep', self)
        self.power_sweep_button.setToolTip('Sweep across a range of power levels, saving data at each step.')
        self.power_sweep_button.move(1305, 935)
        self.power_sweep_button.resize(140, 100)
