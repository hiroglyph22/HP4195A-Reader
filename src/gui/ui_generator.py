...
class UIGenerator:
    ...
    def generate_UI(self):
        ...
        self.machine_setup_button = QtWidgets.QPushButton('Machine Setup')
        self.machine_setup_button.setToolTip('View and configure machine settings, display current values, and export configuration')
        ...
        actions_layout.addWidget(self.machine_setup_button, 2, 0, 1, 2)  # Span across both columns
    ...
    def generate_menu_bar(self):
        ...
        # Tools menu
        machine_setup_action = QtWidgets.QAction('&Machine Setup...', self)
        machine_setup_action.setShortcut('Ctrl+M')
        machine_setup_action.triggered.connect(self.show_machine_setup)
        self.tools_menu.addAction(machine_setup_action)
