...
class UIGenerator:
    ...
    def generate_UI(self):
        ...
        self.generate_amplitudes_control_section()
    ...
    def generate_low_res_sweep_button(self):
        ...
        self.low_res_sweep_button.move(750, 935)
    ...
    def generate_range_scan_section(self):
        ...
        self.start_freq_label.resize(140, 30)
        self.start_freq_label.move(10, 970)
        self.start_freq_input = QtWidgets.QLineEdit(self)
        self.start_freq_input.move(155, 970)
        self.start_freq_input.resize(150, 30)

        self.stop_freq_label = QtWidgets.QLabel('Stop Freq (Hz):', self)
        self.stop_freq_label.resize(140, 30)
        self.stop_freq_label.move(315, 970)
        self.stop_freq_input = QtWidgets.QLineEdit(self)
        self.stop_freq_input.move(460, 970)
        self.stop_freq_input.resize(150, 30)

        self.range_scan_button = QtWidgets.QPushButton('Scan Freq Range', self)
        self.range_scan_button.setToolTip('Set start and stop frequency and acquire data')
        self.range_scan_button.move(620, 970)
        self.range_scan_button.resize(180, 30)
        self.range_scan_button.clicked.connect(self.start_range_scan)

    def generate_amplitudes_control_section(self):
        self.start_amplitude_label = QtWidgets.QLabel('Start Amplitude (dBm):', self)
        self.start_amplitude_label.resize(140, 30)
        self.start_amplitude_label.move(1050, 935)
        self.start_amplitude_input = QtWidgets.QLineEdit(self)
        self.start_amplitude_input.setPlaceholderText("-20")
        self.start_amplitude_input.move(1195, 935)
        self.start_amplitude_input.resize(100, 30)

        self.stop_amplitude_label = QtWidgets.QLabel('Stop Amplitude (dBm):', self)
        self.stop_amplitude_label.resize(140, 30)
        self.stop_amplitude_label.move(1050, 970)
        self.stop_amplitude_input = QtWidgets.QLineEdit(self)
        self.stop_amplitude_input.setPlaceholderText("0")
        self.stop_amplitude_input.move(1195, 970)
        self.stop_amplitude_input.resize(100, 30)

        self.step_amplitude_label = QtWidgets.QLabel('Step (dBm):', self)
        self.step_amplitude_label.resize(140, 30)
        self.step_amplitude_label.move(1050, 1005)
        self.step_amplitude_input = QtWidgets.QLineEdit(self)
        self.step_amplitude_input.setPlaceholderText("1")
        self.step_amplitude_input.move(1195, 1005)
        self.step_amplitude_input.resize(100, 30)
        
        self.sweeping_range_of_amplitudes_button = QtWidgets.QPushButton('Start', self)
        self.sweeping_range_of_amplitudes_button.setToolTip('Sweep across a range of amplitude levels, saving data at each step.')
        self.sweeping_range_of_amplitudes_button.move(1305, 935)
        self.sweeping_range_of_amplitudes_button.resize(140, 100)

    def generate_command_box(self):
        self.command_box = QtWidgets.QLineEdit(self)
        self.command_box.move(140, 1040)
    ...
    def generate_response_box(self):
        ...
        self.response_box.move(140, 1075)
        ...
        self.response_box_label.move(10,1075)